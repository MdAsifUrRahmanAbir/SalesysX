...
class NewSaleEntryMobileView extends ConsumerWidget {
  const NewSaleEntryMobileView({super.key});
              ...
              child: ListView(
                ...
                children: [
                  ...
                  SubmitSaleEntryButton(
                    onPressed: () {
                      // TODO: wire to controller.submitSaleEntry() then a
                      // success snackbar + list refresh, once the
