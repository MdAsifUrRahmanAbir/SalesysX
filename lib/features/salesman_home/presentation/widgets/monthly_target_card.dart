...
/// Monthly sales target card: a circular achieved-percentage ring next to
/// target / achieved / remaining figures. Feature-specific composition —
/// not promoted to core, since the ring + 3-figure layout is unique to
