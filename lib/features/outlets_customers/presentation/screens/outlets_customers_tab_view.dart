...
class OutletsCustomersTabView extends ConsumerWidget {
  const OutletsCustomersTabView({super.key});
                          ...
                          children: [
                            OutletList(
                              ...
                              onOutletTap: (outlet) {
                                ...
                                // RouteNames.outletDetail, extra: outlet)
                                // once an outlet detail screen exists.
                              },
                            ),
                          ],
                        ),
